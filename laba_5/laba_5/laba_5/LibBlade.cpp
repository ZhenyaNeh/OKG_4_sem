...
CBlade::CBlade()            
{
	...
	//MainPoint.SetRect(-R, R, R, -R);				// Прямоугольник солнца - для рисования круга
	////Lopast_1_Orbit.SetRect(-RoE, RoE, RoE, -RoE);	// Прямоугольник орбиты Земли - для рисования круга
	...
	//fiFB = 45 + fi / 4;
	//fiST = 0 - fi / 4;
	//fiFT = 45 - fi / 4;//угол положение для FT
	//wPoint = -speed;
	////dt = -speed;
	//dt = 0.1;


	////fiL1 = 0 + fi / 4;			// Угловое положение Земли в системе кординат Солнца, град
	////fiL2 = 45 + fi / 4;			// Угловое положение Луны в системе кординат Земли, град

	////fiL11 = 0 - fi / 4;
	////fiL21 = 45 - fi / 4;


	////wLopast_1 = -speed;			// Угловая скорость Земли в системе кординат Солнца, град/сек.
	////// Угловая скорость Луны в системе кординат Земли, град/сек.
	////wLopast_2 = -speed;
...
void CBlade::DrawTriangle(CMatrix FTCoords, CMatrix STCoords, CDC& dc) // рисуем треугольник в контексте устройства
{
